...
engine = create_engine("postgres://postgres:12345678@192.168.1.115:5432/books")
db = scoped_session(sessionmaker(engine))

# A little test
# res = requests.get("https://www.goodreads.com/book/review_counts.json", params={"key": "8QIB6ebSMAikfz3y1usZUQ", "isbns": "9781632168146"})
# print(res.json())
